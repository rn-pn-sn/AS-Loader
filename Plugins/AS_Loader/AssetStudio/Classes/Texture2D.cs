...
namespace AssetStudio
{
    public sealed class Texture2D : Texture
    {
        ...
        public Texture2D(ObjectReader reader, byte[] type, JsonSerializerSettings jsonOptions) : base(reader)
        {
            var jsonString = Encoding.UTF8.GetString(type);
            var parsedTex2d = JsonConvert.DeserializeObject<Texture2D>(jsonString, jsonOptions);
