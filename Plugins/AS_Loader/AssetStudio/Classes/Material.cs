...
namespace AssetStudio
{
    ...
    public sealed class Material : NamedObject
    {
        ...
        public Material(ObjectReader reader, byte[] type, JsonSerializerSettings jsonOptions) : base(reader)
        {
            var jsonString = Encoding.UTF8.GetString(type);
            var parsedMaterial = JsonConvert.DeserializeObject<Material>(jsonString, jsonOptions);
