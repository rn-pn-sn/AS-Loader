...
namespace AssetStudio
{
    public sealed class Texture2DArray : Texture
    {
        ...
        public Texture2DArray(ObjectReader reader, byte[] type, JsonSerializerSettings jsonOptions) : base(reader)
        {
            var jsonString = Encoding.UTF8.GetString(type);
            var parsedTex2dArray = JsonConvert.DeserializeObject<Texture2DArray>(jsonString, jsonOptions);
