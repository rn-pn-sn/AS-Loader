...
#pragma warning disable CS8973 // The operation may overflow at runtime (use 'unchecked' syntax to override)
                    assert(job->src.size < 2147483647 * chunkSize);
#pragma warning restore CS8973 // The operation may overflow at runtime (use 'unchecked' syntax to override)
#endif
                assert(job->cSize == 0);
