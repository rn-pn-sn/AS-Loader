...
namespace AssetStudio
{
    ...
    {
        public AssetStudioBundle assetsManager;
        ...
        public SerializedFile(FileReader reader, AssetStudioBundle assetsManager)
        {
            ...
            if (header.m_Version >= SerializedFileFormatVersion.Unknown_7)
            {
                ...
                {
                    Debug.LogWarning($"Failed to parse Unity version: \"{verStr}\"");
